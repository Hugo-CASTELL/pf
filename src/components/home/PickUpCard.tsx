...
export function PickUpCard(props: PickUpCardProps){
  return (
    <button
      className={`min-w-[180px] cursor-pointer rounded-t-extra flex flex-col justify-start transition-all duration-250 ease-in-out ${props.classNameAddition} border-x-3 border-t-3 border-background-neutral-secondary`}
    >
